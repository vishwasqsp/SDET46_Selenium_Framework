...
public class ModifyDataFromProject {
	...
	public static void main(String[] args) throws SQLException {
		...
		String prjManagerName = "Roman";
		String projecId = "TY_PROJ_"+new Random().nextInt(100);
		String query = "insert into project values('"+projecId+"','"+prjManagerName+"','08/02/2023', 'SeleniumJDBC', 'Created', '3');";
